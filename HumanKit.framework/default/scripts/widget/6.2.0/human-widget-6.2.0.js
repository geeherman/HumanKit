  ...
  ['$window', '$parse', '$q', '$interval', 'widgetData', 'HumanUserAnalytics', 'HumanDeveloperActivity', function (
    ...
    return {
      ...
      recordAPI: function (_config) {
        ...
        HumanDeveloperActivity.post(buildAPIActivity())
          .then(config.success, config.failure);
      },
      ...
      verify: function () {
        // Verify domain
        this.record({ failure: domainFailure });

        // Independantly check developer key for API usage
        this.recordAPI({ success: apiSuccess, failure: apiFailure });
      }
