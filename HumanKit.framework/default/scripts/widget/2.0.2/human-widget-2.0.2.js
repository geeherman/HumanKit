...
/*
 * Human Scene Loader v-2
 * Built on 12.07.2015 05:57:59 PM
 * (c) 2015 BioDigital, Inc.
 */
    ...
    return {
      ...
      setContent: function () {
        ...
        if(searchParams.camera) {
          content.camera = searchParams.camera;
        }
...
.factory('ModuleManager', ['$q', '$timeout', 'ChapterManager', function ($q, $timeout, ChapterManager) {
  ...
  return {
    ...
    load: function (moduleId, baseAnatomyObjects, bookmark) {
      var deferred = $q.defer();
...
.factory('HumanBootstrap', ['$document', '$q', '$rootScope', '$ocLazyLoad', 'INIT_FILE', 'BackgroundImage', 'humanFiles', 'widgetParams', 'HumanScene', function ($document, $q, $rootScope, $ocLazyLoad, INIT_FILE, BackgroundImage, humanFiles, widgetParams, HumanScene) {
  var loaded = $q.defer();
