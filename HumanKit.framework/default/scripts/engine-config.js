...
window.engineConfig = function () {
  ...
  // Config default language for assets
  var queryLocale = Human.request.getSearchParam('locale');
  if(queryLocale) {
    Human.locale = queryLocale;
  }
  ...
  if (Human.view.annotations.setResponsiveEnabled) {
    var annotationCollapse = HumanWidget.params['annotation-collapse'];
