...
(function () {
    ...
    var contextView = new (function () {
        ...
        var humanCanvas = Human.renderer.canvas.annotationCanvas[0];
        ...
        function createContextView() {
            ...
            lookatNode = scene.getNode("theLookat");
            cameraNode = scene.getNode("theProjection");
            ...
            var synchContextViewCamera = contextView.synchContextViewCamera = (function () {
                ...
                function contextWorldToView(worldPos, viewPos) {
                    var viewMat = lookatNode.getMatrix();
                ...
                var contextViewToCanvas = (function () {
                    ...
                    return function (viewPos, canvasPos) {
                        var projMat = cameraNode.getMatrix();
                ...
                return function () {
                    ...
                    lookatNode.setLook({x: contextCenter[0], y: contextCenter[1], z: contextCenter[2]});
                    lookatNode.setEye({
                        x: contextCenter[0] + (contextEyeOffset[0] * sca),
                        y: contextCenter[1] + (contextEyeOffset[1] * sca),
                        z: contextCenter[2] + (contextEyeOffset[2] * sca)
                    });
                    lookatNode.setUp({x: 0, y: 1, z: 0});
                    ...
                    if (frameBoxEnabled) {
                        ...
                        var rayResults = Human.math.intersections.raySceneAabb(humanEye, rayDir, function(object) {
                            return object.shown && !object.isTransparent();
                        });
                        ...
                        if (rayResults) {
                            ...
                            if (Human.math.intersections.pointAabb(humanEye, boundaryMin, boundaryMax)) {
                                ...
                                targetDistance = cameraNode.getOptics().near;
