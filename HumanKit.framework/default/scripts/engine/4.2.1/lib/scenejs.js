...
var SceneJS_math_buildTangents =  function (positions, indices, uv) {
...
;new (function () {
    ...
    SceneJS.Geometry.prototype._initNodeCore = function (data, options) {
        ...
        core.getTangentBuf = function () {
            ...
            if (arrays.positions && arrays.indices && arrays.uv) {
                ...
                var tangents = new Float32Array(SceneJS_math_buildTangents(arrays.positions, arrays.indices, arrays.uv)); // Build tangents array;
     ...
     */
    SceneJS.Geometry.prototype._buildNodeCore = function () {
                ...
                image.onload = (function() {
                    ...
                    return function () {
                        ...
                        if (images.length == 6) {
                            ...
                            self._core.webglRestored = build;
