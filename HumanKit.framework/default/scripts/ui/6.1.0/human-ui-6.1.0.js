...
.directive('zoomCamera', ['$interval', 'Human', 'destroyInterval', function ($interval, Human, destroyInterval) {
      ...
      var subId = properties.subscribe({
        ...
        callback: function (mode) {
          $timeout(function () {
            ...
            scope.tooltipTitle = mode === 'orbit' ? 'Pan' : 'Orbit';
            scope.$apply();
          });
        }
      });
...
angular.module('templates/fullscreen/panel.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('templates/fullscreen/panel.html',
    '<div\n' +
    '  class="fullscreen"\n' +
    '  toggle-button="toggleFullscreen"></div>');
}]);
