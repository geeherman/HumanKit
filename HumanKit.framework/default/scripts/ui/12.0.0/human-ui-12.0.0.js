...
.factory('Hotspot',
  ['$window', '$filter', '$interpolate', 'HOTSPOT_TYPES', 'HOTSPOT_CLASSES', 'HotspotData', 'Human', 'HumanParser', 'HumanActions', 'currentModule', 'doTween', function (
    $window, $filter, $interpolate,
    HOTSPOT_TYPES, HOTSPOT_CLASSES,
    HotspotData, Human, HumanParser, HumanActions,
    currentModule, doTween
  ) {
...
.run(['$window', 'Human', 'HumanBackground', 'HumanAction', 'HumanActions', 'Hotspot', 'Media', 'Info', 'doTween', function (
    $window,
    Human, HumanBackground, HumanAction, HumanActions,
    Hotspot, Media, Info, doTween
  ) {
...
.directive('humanAnnotations', ['$timeout', 'Human', function ($timeout, Human) {
  return {
    restrict: 'E',
    scope: true,
...
.directive('humanDissect', ['$timeout', 'Human', function ($timeout, Human) {
  return {
    restrict: 'E',
    scope: true,
...
.directive('humanXray', ['$timeout', 'Human', function ($timeout, Human) {
  return {
    restrict: 'E',
    scope: true,
...
.directive('humanIsolate', ['$timeout', 'Human', function ($timeout, Human) {
  return {
    restrict: 'E',
    scope: true,
