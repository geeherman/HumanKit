...
.directive('humanObjectSlider',
  ['Human', 'HumanSlider', 'ObjectOpacities', 'HumanParser', 'currentModule', function (Human, HumanSlider, ObjectOpacities, HumanParser, currentModule) {
    return {
      restrict: 'E',
...
.directive('humanScrubber',
  ['$filter', '$timeout', 'Human', 'HumanTimeline', 'HumanSlider', function ($filter, $timeout, Human, HumanTimeline, HumanSlider) {
    return {
      restrict: 'E',
      scope: true,
