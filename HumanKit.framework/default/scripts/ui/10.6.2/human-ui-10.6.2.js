...
.run(['$window', '$timeout', 'Human', 'currentModule', 'HumanBackground', 'HumanActions', 'Hotspot', 'Media', 'doTween', function (
    $window, $timeout,
    Human, currentModule, HumanBackground, HumanActions, Hotspot, Media, doTween
  ) {
  ...
  // Camera action
  var cameraAction = function (data) {
