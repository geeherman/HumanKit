...
.factory('RpcDefinitions', ['$document', 'ConfigCreator', 'Human', function ($document, ConfigCreator, Human) {
    ...
    init: function () {
      ...
      Human.rpc.define('injectStyles', function (styles) {
        if(styleTag) {
          ...
          // Redraw annotations, just in case the new styles have affected them
