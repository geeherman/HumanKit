...
// TODO: Don't rely on $parse, write home-made limited parser.
  ...
  var doActions = function (actions, customContext, callback) {
    ...
    if(actionsMap.hasOwnProperty(_instruction)) {
      ...
      for (var i = 0; i < _arguments.length; i++) {
        _arguments[i] = $parse(_arguments[i])(context);
      }
...
.run(['$window', '$timeout', 'Human', 'currentModule', 'HumanBackground', 'HumanActions', 'Hotspot', function (
  ...
  var currentFunctions = {
    ...
    now: function () { // Prefer currentTime
  ...
  HumanActions.define(['play'], playAction, context);
  ...
  HumanActions
    .define(['hideAnnotations', 'showAnnotations'], annotationsAction, context);
