  ...
  ['$window', '$filter', '$interpolate', 'HOTSPOT_TYPES', 'HotspotData', 'Human', 'HumanActions', function (
    ...
    */
    ...
    Hotspot.prototype.setCanvasPos = function () {
      ...
      // Within Canvas dimensions and in front of camera
      inView =
        this.canvasPos[0] > 0 &&
    ...
    return {
      init: function () {
        ...
        Human.rpc.define('hotspots.update', function (hotspotUpdate) {
          // Select srcData by id
          var srcData = HotspotData.all[hotspotUpdate.id];
          ...
          var hotspot = Hotspot.get(hotspotUpdate.id);
