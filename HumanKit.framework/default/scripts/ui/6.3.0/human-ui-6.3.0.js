...
.directive('humanPlayPause', ['assetAttachClass', 'hasPlayableTimeline', function (assetAttachClass, hasPlayableTimeline) {
  return {
    restrict: 'E',
    scope: true,
...
.directive('humanScrubber',
  ['$filter', 'Human', 'assetAttachClass', 'hasPlayableTimeline', function ($filter, Human, assetAttachClass, hasPlayableTimeline) {
    return {
      restrict: 'E',
      scope: true,
      ...
      link: function (scope, element) {
        ...
        scope.$watch('uiComponents.config.scrubber', function (n) {
          if(n && !scope.uiComponents.config.tour) {
            configShow = !!n;
            setShown();
          }
  ...
  return {
    ...
    link: function (scope, element) {
      ...
      scope.$watch('uiComponents.config.tour', function (n) {
        if(n && !scope.uiComponents.config.scrubber) {
          configShow = !!n;
          setShown();
        }
