      ...
      link: function (scope, element) {
        ...
        Human.events.on('modules.activate.finish', function () {
          if (firstActivate) {
            ...
            var startIndex = Human.timeline.activeRoot.whereIsBranch(nowBranch);

            // Create start chapter's hotspots
            createChapterHotspots(startIndex);
        ...
        Human.events.on('timeline.chapters.activated', function (data) {
          // Protect against uneccessary reinstantiation
          if (data.newChapterIndex === currentChapter) {
            return;
          }
