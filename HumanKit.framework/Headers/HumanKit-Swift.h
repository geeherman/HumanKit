...
/// Annotation object
SWIFT_CLASS("_TtC8HumanKit10Annotation")
...
typedef SWIFT_ENUM(NSInteger, BackgroundOptions) {
...
/// Camera object
SWIFT_CLASS("_TtC8HumanKit6Camera")
...
/// Chapter object
SWIFT_CLASS("_TtC8HumanKit7Chapter")
...
@property (nonatomic, strong) Chapter * _Nullable currentChapter;
/// A map of chapter IDs to Chapter objects.
@property (nonatomic, copy) NSDictionary<NSString *, Chapter *> * _Nonnull chapters;
...
@property (nonatomic, copy) NSDictionary<NSString *, Annotation *> * _Nonnull annotations;
...
/// Loads “about:blank”
/// \param callback A closure to run after the blank screen load
///
- (void)unload;
/// Loads an empty screen
...
/// \param eid String version of ICD number
///
///
/// returns:
/// [Module] an array of found Module objects, empty if none are found
- (NSArray<Module *> * _Nonnull)findModuleWithICD:(NSString * _Nonnull)ICD SWIFT_WARN_UNUSED_RESULT;
...
- (NSString * _Nonnull)getDisplayNameWithObjectID:(NSString * _Nonnull)objectID SWIFT_WARN_UNUSED_RESULT;
...
- (Camera * _Nonnull)getCameraInfo SWIFT_WARN_UNUSED_RESULT;
...
///
- (nonnull instancetype)initWithValidateKey:(NSString * _Nonnull)validateKey OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM(NSInteger, HumanUIOptions) {
...
/// Module object
SWIFT_CLASS("_TtC8HumanKit6Module")
@interface Module : NSObject
/// ID of the module.  example: production/maleAdult/flu.json
@property (nonatomic, copy) NSString * _Nonnull moduleID;
/// module title
@property (nonatomic, copy) NSString * _Nonnull title;
/// module description: this is accessible only for the current loaded module
@property (nonatomic, copy) NSString * _Nonnull info;
- (nonnull instancetype)initWithModuleID:(NSString * _Nonnull)moduleID title:(NSString * _Nonnull)title info:(NSString * _Nonnull)info OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
